...
class  Live extends React.Component {
    ...
    render(){
        return this.props.info.map(courses =>{
            return (
                    ...
                    <div>
                        <div className="list-group" id="list-tab" role="tablist">
                            <li style={{textDecoration:"none"}} className="list-group-item  d-flex justify-content-between align-items-center" id="list-home-list" data-toggle="list"
                                href="#list-home" role="tab" aria-controls="home">{courses.courseName} <span className="badge badge-primary badge-pill">inprogress</span></li>
                        </div>
                    </div>
                    <div>
